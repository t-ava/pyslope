...
importedAddress = avm.importKey(API_NODE_IP, usernames[1], passwords[1], genesisPrivateKey)
print("import", importedAddress)
importAddressesFromFile(usernames[1], passwords[1], "stations_5.txt")

print(usernames[0], "balance:", avm.getAllBalances(API_NODE_IP, xAddresses[0]))
print(usernames[1], "balance:", avm.getAllBalances(API_NODE_IP, xAddresses[1]))
print(usernames[1], "balance:", avm.getAllBalances(API_NODE_IP, stationAddresses[0]))
print(usernames[1], "balance:", avm.getAllBalances(API_NODE_IP, stationAddresses[1]))
print(usernames[1], "balance:", avm.getAllBalances(API_NODE_IP, stationAddresses[2]))
print(usernames[1], "balance:", avm.getAllBalances(API_NODE_IP, stationAddresses[3]))
print(usernames[1], "balance:", avm.getAllBalances(API_NODE_IP, stationAddresses[4]))
print(usernames[2], "balance:", avm.getAllBalances(API_NODE_IP, xAddresses[2]))
print()



# avm.send(API_NODE_IP, 10000, "AVA", stationAddresses[0], usernames[0], passwords[0], ["X-"+genesisAddress])
# avm.send(API_NODE_IP, 50000, "AVA", stationAddresses[0], usernames[1], passwords[1], [stationAddresses[1], stationAddresses[2]])

avm.send(API_NODE_IP, 50000, "AVA", stationAddresses[0], usernames[1], passwords[1], [xAddresses[2]])
# avm.send(API_NODE_IP, 200000, "AVA", xAddresses[1], usernames[0], passwords[0], "X-"+genesisAddress)
time.sleep(2)
